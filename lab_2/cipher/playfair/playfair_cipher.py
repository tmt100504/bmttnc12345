class PlayFairCipher:
    ...
    def playfair_decrypt(self, cipher_text, matrix):
        ...
        for i in range(0, len(cipher_text), 2):
            ...
            row1, col1 = delf.find_letter_coords(matrix, pair[0])
            row2, col2 = delf.find_letter_coords(matrix, pair[1])
            ...
            banro = ""
            #Loai bo ky tu 'X' neu no la ky tu cuoi cung va la ki tu duoc them vao
